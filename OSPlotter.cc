...
OSPlotter::OSPlotter(string FileName){
...
void OSPlotter::PlotLabelHistogramm(string TreeName, string BranchName, unsigned MinEntries){
    ...
    std::vector<string> AxisLabelSorted = SortAxisLabels(AxisLabel, Label_Occurrence, MinEntries); 
...
void OSPlotter::PlotLabelCombiHistogramm(string TreeName, string BranchName1, string BranchName2, unsigned MinEntries){

    // Get the stuff you need from the File: 
    //string *Workflow;             // Not sure I need this yet...
    std::vector<string> *Label1; 
    TBranch *b_Label1; 
...
void OSPlotter::PlotLabelHistogrammComparison(string TreeNameXAxis, string TreeNameComp1, string TreeNameComp2, string BranchName, unsigned MinEntries){
...
void OSPlotter::PlotLabelHistogrammStack(string TreeNameXAxis, string TreeNameStack1, string TreeNameStack2, string BranchName, unsigned MinEntries){
    ...
    TH1D *h1_Stack1 = new TH1D(Form("h1_%s_%s_StackComp", TreeNameStack1.c_str(), BranchName.c_str()), Form("%s %s", TreeNameStack1.c_str(), BranchName.c_str()), NoLabels, 0., NoLabels);
    h1_Stack1->SetLineColor(kBlue);
    h1_Stack1->SetFillColor(kBlue);
    
    
    std::vector<string> *LabelStack2; 
    ...
    TH1D *h1_Stack2 = new TH1D(Form("h1_%s_%s_StackComp", TreeNameStack2.c_str(), BranchName.c_str()), Form("%s %s", TreeNameStack2.c_str(), BranchName.c_str()), NoLabels, 0., NoLabels);
    h1_Stack2->SetLineColor(kRed);
    h1_Stack2->SetFillColor(kRed);
    
    THStack *st_Label = new THStack(Form("st_%s_%s_%s_Stack", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), Form("%s %s %s", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str())); 
    ...
    TCanvas *c_Stack = new TCanvas(Form("c_%s_%s_%s_Stack", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), Form("c_%s_%s_%s_Stack", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), 800, 500);
    TPad  *pad_Stack = new TPad(Form("pad_%s_%s_%s_Stack", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), Form("pad_%s_%s_%s_Stack", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), 0., 0., 1., 1.); 
    pad_Stack->Draw(); 
    pad_Stack->cd(); 
...
void OSPlotter::PlotLabelHistogrammStackNormalized(string TreeNameXAxis, string TreeNameStack1, string TreeNameStack2, string BranchName, unsigned MinEntries){
    ...
    THStack *st_Label = new THStack(Form("st_%s_%s_%s_StackNorm", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), Form("%s %s %s", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str())); 
    ...
    TCanvas *c_Stack = new TCanvas(Form("c_%s_%s_%s_StackNorm", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), Form("c_%s_%s_%s_StackNorm", TreeNameStack1.c_str(), TreeNameStack2.c_str(), BranchName.c_str()), 800, 500);
...
void OSPlotter::PlotLabelHistogramm2D(string TreeNameX, string BranchNameX, unsigned MinEntriesX, string TreeNameY, string BranchNameY, unsigned MinEntriesY, bool MergeAxisLabels){

    // X-axis 
    string *WorkflowX; 
    TBranch *b_WorkflowX; 
    std::vector<string> *LabelX; 
    TBranch *b_LabelX; 
    ...
    std::vector<string> AxisLabelSortedX; 
    std::vector<string> AxisLabelSortedY; 
    ...
    TH2D *h2_Label = new TH2D(Form("%s_%s_%s_%s", TreeNameX.c_str(), BranchNameX.c_str(), TreeNameY.c_str(), BranchNameY.c_str()), Form("%s_%s_%s_%s", TreeNameX.c_str(), BranchNameX.c_str(), TreeNameY.c_str(), BranchNameY.c_str()), NoLabelsX, 0., NoLabelsX, NoLabelsY, 0., NoLabelsY); 
...
void OSPlotter::PlotLabelHistogramm2D(string TreeName, string BranchNameX, unsigned MinEntriesX, string BranchNameY, unsigned MinEntriesY){
    ...
    std::vector<string> AxisLabelSortedX = SortAxisLabels(AxisLabelX, Label_OccurrenceX, MinEntriesX); 
    unsigned NoLabelsX = AxisLabelSortedX.size(); 
    cout<<"Number of different X Labels: "<<NoLabelsX<<endl; 
    ...
    std::vector<string> AxisLabelSortedY = SortAxisLabels(AxisLabelY, Label_OccurrenceY, MinEntriesY); 
    unsigned NoLabelsY = AxisLabelSortedY.size(); 
    cout<<"Number of different Y Labels: "<<NoLabelsY<<endl; 
...
std::vector<string> OSPlotter::SortAxisLabels(std::vector<string> AxisLabelOrg, std::vector<unsigned> Label_OccurrenceOrg){
    
    std::vector<string> AxisLabelCopy = AxisLabelOrg; 
    std::vector<unsigned> Label_OccurrenceCopy = Label_OccurrenceOrg; 
    std::vector<string> NewAxisLabel; 
...
std::vector<string> OSPlotter::SortAxisLabels(std::vector<string> AxisLabelOrg, std::vector<unsigned> Label_OccurrenceOrg, unsigned MinimumOccurrence){
...
std::vector<string> OSPlotter::SortAxisLabels(std::vector<string> AxisLabelOrg1, std::vector<unsigned> Label_OccurrenceOrg1, std::vector<string> AxisLabelOrg2, std::vector<unsigned> Label_OccurrenceOrg2, unsigned MinimumOccurrence){
    
    // If all Labels from two different trees are supposed to be used. 
    
    std::vector<string> AxisLabelCopy1 = AxisLabelOrg1; 
    std::vector<unsigned> Label_OccurrenceCopy1 = Label_OccurrenceOrg1; 
    
    std::vector<string> AxisLabelCopy2 = AxisLabelOrg2; 
