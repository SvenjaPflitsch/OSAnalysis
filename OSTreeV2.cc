...
void OSTreeV2::AddWorkflows(string WorkflowsListName){
...
void OSTreeV2::AddExitCode1(string ExitCode1ListName){
...
void OSTreeV2::AddExitCode2(string ExitCode2ListName){
    ...
    cout<<"ExitCode1: "<<ExitCode2_read.size()<<endl; 
}    

    
void OSTreeV2::AddKeyword(string KeywordListName){
...
void OSTreeV2::AddActionOS(string ActionOSListName){
...
void OSTreeV2::AddThresholdPerc(string ThresholdPercListName){
...
void OSTreeV2::AddThresholdAbs(string ThresholdAbsListName){
...
void OSTreeV2::AddExitCode1Extra(string ExitCode1ExtraListName){
...
void OSTreeV2::AddActionWTC(string ActionWTCListName){
...
void OSTreeV2::AddReasonWTC(string ReasonWTCListName){
